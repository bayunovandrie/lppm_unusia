                    ...
                    <table id="example" class="table table-bordered table-striped" >
                        <thead>
                            <tr>
                                ...
                                <th align="center" style="text-align: center; vertical-align: middle;" >Category Dokumen</th>
                            ...
                            foreach ($category->result_array() as $value) { ?>
                                <tr class="gradeA">
                                    ...
                                    <td align="center" style="text-align: center; vertical-align: middle;">
                                        <a class="btn btn-primary" href="<?= BASEURL ?>download-panduan?categoryid=<?php echo $value['category_id'] ?>"><i class="fas fa-eye ml-2"></i></a>
                                    </td>
