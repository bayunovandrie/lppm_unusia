                  ...
                  <div class="container">
                    <div class="card-kedua" id="myCard2"  style="display: none;">
                      ...
                      <div class="card-body">
                        ...
                        <p class="card-text">Berikut Adalah Jurnal Dan Riset Yang Dilakukan Oleh Lembaga Penelitian Dan Pengabdian Masyarakat Universitas Nahdlatul Ulama Indonesia</p>
                        <div class="row">
                            <div class="col-md-6 mt-4">
                                <button class="btn btn-success">Learn More</button>
                            </div>
                ...
                <div class="container">
                    <div class="row ">
                        ...
                        <div class="col-md-3">
                            ...
                            <p>Membangun kapasitas kelembagaan (institutional building) termasuk payung kajian, penelitian dan pengabdian kepada masyarakat berbasis Ilmu Pengetahuan, Teknologi dan Kearifan sesuai perkembangan Iptek dan dan tantangan jaman</p>
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3" >
                            ...
                            <p>Melakukan penelitian dan pengabdian kepada masyarakat dengan kualitas dan kuantitas yang terus meningkat dan serta mempublikasikan hasil-hasil penelitian di tingkat nasional dan internasional.</p>
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3" >
                            ...
                            <p>Menghasilkan produk dan jasa penelitian yang inovatif berbasis Ilmu Pengetahuan, Teknologi, dan Kearifan Sosial yang bermanfaat optimal untuk kepentingan masyarakat, dunia usaha dan industri.</p>
                        </div>

                    </div>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#f0f8ff" fill-opacity="1" d="M0,192L80,160C160,128,320,64,480,80C640,96,800,192,960,229.3C1120,267,1280,245,1360,234.7L1440,224L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
            </section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card rounded-card" style="width: 18rem;">
                                      ...
                                      <div class="card-body">
                                        <a href="<?= BASEURL ?>Article/baca?id=<?= $value['article_id'] ?>" style="color:black;">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="row mt-4">
                            <?php foreach ($artikel_opini->result_array() as $value) {?>
                                <div class="col-md-4">
                                    <div class="card rounded-card" style="width: 18rem;">
                                      <img src="http://localhost/CI3_admin/assets2/images/article/<?= $value['article_img'] ?>" class="card-img-top">
                                      <div class="card-body">
                                        <a href="<?= BASEURL ?>Article/baca?id=<?= $value['article_id'] ?>" style="color: black;">
                                        <p class="card-title" style="font-weight: bold;"><?= $value['article_judul'] ?></p>
